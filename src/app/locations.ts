...
export const locations: Location[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '',
      'Ehrlich gesagt, die Entführer haben nicht weniger verwirrt gewirkt als ihr gerade.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Ich muss gar keine komplizierten Fallen stellen, damit wir gemeinsam etwas unternehmen können!',
      '',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '',
      'Der Siebenundzwanzigste schon??',
      'Aber die Sonne geht immer noch auf. Irgendjemand muss zu Weihnachten meine Pflichten übernommen haben.',
      ...
      'In der ganzen Vampirgesellschaft ist er angesehen als erfolgreicher Wissenschaftler und einer der wenigen, der halbwegs vernünftig mit Malkavianern umzugehen weiss.',
      ...
      '',
      'Mitten in der Bibliothek sitzt er am frühen Abend der 27. Dezember, als es wie jedes Jahr an seiner Tür klingelt.',
      '',
      'Wie jedes Jahr liegen auf seiner Fussmatte zwei Weihnachtskarten.',
      '',
      'Wie jedes Jahr, keine Namen.',
      '',
      'Wie jedes Jahr, sieht Jeremiah im Augenwinkel die zwei Männer die versuchen ihn unauffällig aus der Dunkelheit am Ende des Flurs zu beobachten.',
      '',
      'Wie jedes Jahr, tut er so als würde er sie nicht sehen.',
      '',
      'Wie jedes Jahr, muss er schmunzeln, wenn kurz danach Mr. O und Mr. K anrufen und beschwören wie enttäuscht sie von ihm sind.',
      '',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Zurückgeholt hat sie ihn wahrscheinlich nicht. Seine Zeit hier war vorbei.',
      ...
      '',
      'Der Anschlag auf die Trimere in Amerika, diverse Morde und verschwundene Vampire wurden am Ende ebenfalls Bishops alias Nephrandis Einfluss zugeschrieben.',
      'Die Menschen feierten Luis mutiges Opfer. Durch seinen Einsatz konnte er einem Massenmoörder die Mittel nehmen weiterzumachen.',
      'Aber auch die Vampirgesellschaft war ungewohnt geeint im Andenken an Luis Cruz - den Sterblichen die sie alle gerettet hatte.',
      '',
      ...
      '',
      'Jedes Jahr, am 27. Dezember, wenn sich die Nacht jährt in der Luis Nephrandis Magie zum Opfer fiel, herrscht Frieden.',
      'Und alle Vampire sehen zum Himmel und erinnern sich beim Anblick eines neuen Sterns am Himmel an Luis Cruz.',
      '',
      'Und was auch immer in Elenas Kopf verloren geht, wohin auch immer sie sich verläuft.',
      '',
      'Niemand, nichteinmal sie, wird ihren Bruder jemals vergessen.'
    ]
  },
]
