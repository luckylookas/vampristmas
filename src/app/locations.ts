...
export const locations: Location[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '',
      'Der Anschlag auf die Trimere in Amerika, diverse Morde und verschwundene Vampire wurden am Ende ebenfalls Bishop`s alias Nephrandi`s Einfluss zugeschrieben.',
